...
def main():
    ...
    train_user_profiles, _, _ = sample_user_profiles(
        args.path_to_categories,
        number_user_profiles=round(args.train_val_test_split[0] * args.num_user),
        number_attributes_per_user=args.num_attributes_per_user,
    )
