...
from dataset.prompts_database.maintenance_utterance_prompt import (
...
class MaintenanceQuestionChain:
    ...
    def __init__(self):
        self.generator_mp = MAINTENANCE_QUESTION_PROMPT_MP | get_llm_gpt4o(
            temperature=0.7
        ).bind(response_format={"type": "json_object"})
        self.generator_mnp = MAINTENANCE_QUESTION_PROMPT_MNP | get_llm_gpt4o(
            temperature=0.7
        ).bind(response_format={"type": "json_object"})

    def generate_maintenance_questions(
        self,
        user_preference,
